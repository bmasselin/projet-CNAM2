...
public class UIScript : MonoBehaviour
{
	...
	public void SetHealth(int playerNumber, int amount)
    {
	...
	public void ChangeHealth(int playerNumber, int change)
    {
		SetHealth(playerNumber, playersHealth[playerNumber] + change);
